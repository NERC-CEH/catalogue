BROWSERS.each do |browser|
  describe "Metadata page in #{browser}", :type => :feature, :driver => browser do
    ...
    describe "UI on metadata page" do
      ...
      it "should show the correct resource status for the UK Butterfly Monitoring Scheme (UKBMS) data record" do
        visit '/documents/571a676f-6c32-489b-b7ec-18dcc617a9f1'
        expect(first('.resource_status')).to have_content "onGoing"
      end

      it "should show the correct resource status for Woodlands survey flora data 1971-2001" do
        visit '/documents/2d023ce9-6dbe-4b4f-a0cd-34768e1455ae'
        expect(first('.resource_status')).to have_content "completed"
      end

      it "should show the correct topic categories for Woodlands survey flora data 1971-2001" do
        visit '/documents/2d023ce9-6dbe-4b4f-a0cd-34768e1455ae'
      ...
      it "should show the correct keywords for Woodlands survey flora data 1971-2001" do
        visit '/documents/2d023ce9-6dbe-4b4f-a0cd-34768e1455ae'
      ...
      it "should show the correct contacts for Woodlands survey flora data 1971-2001" do
        visit '/documents/2d023ce9-6dbe-4b4f-a0cd-34768e1455ae'

            ...
            assertTrue(
                model.contains(
                    createStatement(
                        ...
                        createResource("http://onto.ceh.ac.uk/EF#EnvironmentalMonitoringActivity")
                    )
                )
            );
        }
            ...
            assertTrue(
                model.contains(
                    createStatement(
                        ...
                        createProperty("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"),
                        createResource("http://onto.ceh.ac.uk/EF#EnvironmentalMonitoringFacility")
                    )
                )
            );
        }
            ...
            assertTrue(
                model.contains(
                    createStatement(
                        ...
                        createProperty("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"),
                        createResource("http://onto.ceh.ac.uk/EF#EnvironmentalMonitoringNetwork")
                    )
                )
            );
        }

...
public class DocumentUploadServiceTest {
  ...
  @Mock private MetadataDocument document;
  ...
  private static final File documentUploadTestFolderSecond =
      new File("../document-upload-test-second");

  private static final List<String> checksumLines =
      Lists.newArrayList("4e87705c2a9abae1f29425c87a6749ed *missing-checksum.txt",
  ...
  private static final File incorrectChecksumFile =
      new File(documentUploadTestFolder, "guid/incorrect-checksum.txt");
  private static final File checksumFile =
      new File(documentUploadTestFolder, "guid/valid-checksum.txt");
  ...
  public void get_hasPath() {
    ...
    assertThat(
        actual.getPath(), equalTo(new File(documentUploadTestFolder, "guid").getAbsolutePath()));
  }
  ...
  @Test
  @SneakyThrows
  public void zipHashAndFileHashHaveDifferentNames() {
    dus.zip("guid");
    checksums.renameTo(new File(documentUploadTestFolder, "guid/anything.hash"));
    dus.zip("guid");
  }
  ...
  @Test
  @SneakyThrows
  public void unzip_withChecksumFileDifferentNames() {
    dus.zip("guid");
    checksums.renameTo(new File(documentUploadTestFolder, "guid/anything.hash"));
    dus.unzip("guid");
    val file = new File(documentUploadTestFolder, "guid/valid-checksum.txt");

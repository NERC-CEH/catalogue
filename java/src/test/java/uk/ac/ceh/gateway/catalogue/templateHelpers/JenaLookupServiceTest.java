...
public class JenaLookupServiceTest {
    ...
    void findEidcRelationsForCollection() {
        ...
        triples.add(createResource(dataset1), PSO_METADATASTATUS, "published");
        ...
        triples.add(createResource(dataset2), PSO_METADATASTATUS, "published");
        ...
        triples.add(createResource(other), PSO_METADATASTATUS, "published");
    ...
    public void lookupRelationships() {
        ...
        triples.add(createResource("http://dataset1"), PSO_METADATASTATUS, "published");
    ...
    public void lookupInverseRelationships() {
        ...
        triples.add(createResource("http://monitoringActivity"), PSO_METADATASTATUS, "published");
        triples.add(createResource("http://monitoringActivity"), REL_PRODUCES, createResource("http://dataset1"));
    ...
    public void lookupInverseRelationshipsWithGeometries() {
        ...
        triples.add(createResource("http://monitoringFacility"), PSO_METADATASTATUS, "published");
    ...
    public void inverseRelationshipCombinedGeometries() throws JsonProcessingException {
        ...
        triples.add(createResource("http://monitoringFacility2"), PSO_METADATASTATUS, "published");
    ...
    public void relationshipCombinedGeometriesWithOwner() throws JsonProcessingException {
        ...
        triples.add(createResource("http://monitoringFacility"), DCTERMS_DCTERMS_TITLE, "Monitoring Facility");
        triples.add(createResource("http://monitoringFacility"), PSO_METADATASTATUS, "published");
        triples.add(createResource("http://monitoringFacility"), DCTERMS_TYPE, "Monitoring Facility");
        triples.add(createResource("http://monitoringFacility"), SF_GEOMETRY, geometryString);
        triples.add(createResource("http://monitoringFacility"), HAS_STATUS, "Inactive");
    ...
    public void lookupProgrammeFeatures() {
        ...
        triples.add(createResource("http://facility1"), PSO_METADATASTATUS, "published");
    ...
    public void lookupMetadata() {
        ...
        triples.add(createResource("http://model"), PSO_METADATASTATUS, "published");
    ...
    public void lookupModelApplications() {
        ...
        triples.add(createResource("http://modelApplication1"), PSO_METADATASTATUS, "published");
        ...
        triples.add(createResource("http://modelApplication2"), PSO_METADATASTATUS, "published");
    ...
    public void lookupModels() {
        ...
        triples.add(createResource("http://model1"), PSO_METADATASTATUS, "published");
        ...
        triples.add(createResource("http://model2"), PSO_METADATASTATUS, "published");
    ...
    public void lookupDatasets() {
        ...
        triples.add(createResource("http://dataset2"), PSO_METADATASTATUS, "published");
    ...
    public void lookupLinkDatasets() {
        ...
        triples.add(createResource("http://link1"), PSO_METADATASTATUS, "published");
    ...
    public void checkThatCanLookupWkt() {
        //Given
        Model triples = jenaTdb.getDefaultModel();
        triples.add(createResource("http://doc1"), SF_GEOMETRY, createTypedLiteral("Polygon(12,23)", GEO_WKTLITERAL));

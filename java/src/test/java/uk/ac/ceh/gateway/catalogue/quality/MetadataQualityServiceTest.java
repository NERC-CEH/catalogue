...
public class MetadataQualityServiceTest {
    ...
    public void isNotEmpty() {
        ...
        //when
        val actual = this.service.isEmpty(parsed, "$[?(@.title empty false)]");
    ...
    public void isNullEmpty() {
        //given
        val parsed = JsonPath.parse("{\"unknown\": \"\"}", this.config);
    ...
    @Test
    public void complexPathOnArrayIsMissing() {
        //given
        val parsed = JsonPath.parse("{\"useConstraints\":[{\"code\": \"license\"},{\"code\": \"another\"}]}", this.config);

        //when
        val actual = this.service.isMissingPath(parsed, "Use constraints is missing", "$.useConstraints[?(@.code == 'license')]").isPresent();
    ...
    public void stringPassesIsMissing() {
        ...
        //when
        val actual = this.service.isMissing(parsed, "Title", "title").isPresent();
    ...
    public void multiLevelStringPassesIsMissing() {
        ...
        //when
        val actual = this.service.isMissing(parsed, "Title", "container.title").isPresent();
    ...
    public void hasCorrectCount() {
        //given
        val parsed = JsonPath.parse("{\"collection\": [1,2]}", this.config);

        //when
        val actual = this.service.hasCount(parsed, "Collection", "$.collection", 2).isPresent();
    ...
    public void hasTooManyCount() {
        //given
        val parsed = JsonPath.parse("{\"collection\": [1,2,3,4]}", this.config);
    ...
    public void hasNullCount() {
        //given
        val parsed = JsonPath.parse("{\"unknown\": [1,2]}", this.config);
    ...
    public void hasEmptyListCount() {
        //given
        val parsed = JsonPath.parse("{\"collection\": []}", this.config);
    ...
    @Test
    public void missingOrganisationNameCheckAddress() {
        //given
        val parsed = JsonPath.parse(getClass().getResourceAsStream("checkAddressMissingOrganisation.json"), this.config);

        //when
        val actual = this.service.checkOrganisationName(parsed, "Test", "metadataPointsOfContact", ERROR).isPresent();
    ...
    public void correctAddress() {
        ...
        //when
        val actual = this.service.checkAddress(parsed, "Test", "metadataPointsOfContact", ERROR).isPresent();
    ...
    @Test
    public void addressHasCehEmail() {
        //given
        val parsed = JsonPath.parse(getClass().getResourceAsStream("checkAddressHasCehEmail.json"), this.config);

        //when
        val actual = this.service.reportNonStandardEmail(parsed, "Metadata contact", "metadataPointsOfContact", ERROR).isPresent();

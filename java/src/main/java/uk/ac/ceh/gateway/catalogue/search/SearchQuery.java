...
public class SearchQuery {
    ...
    public SolrQuery build(){
        SolrQuery query = new SolrQuery()
                ...
                .setParam("qf", "title^50 description^25 keyword^2 keywords_all^2 lineage organisation individual surname altTitle resourceIdentifier identifier supplementalDescription supplementalName infrastructureCapabilities^2")
                ...
                .setParam("bf", "version")
                .setParam("ps", "5")
                .setParam("pf", "title^50 description^25 keyword^2 keywords_all^2 supplementalDescription")

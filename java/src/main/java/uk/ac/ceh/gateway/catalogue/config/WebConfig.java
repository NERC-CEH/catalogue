...
public class WebConfig extends WebMvcConfigurerAdapter {
    ...
    public static final String DEPOSITAGREEMENT_SHORT        = "deposit-agreement";
    public static final String DEPOSITAGREEMENT_JSON_VALUE   = "application/vnd.deposit-agreement+json";
        ...
        configurer
            ...
            .defaultContentTypeStrategy(new ContentNegotiationManager(
                    new ForgivingParameterContentNegotiationStrategy(ImmutableMap.<String, MediaType>builder()
                        ...
                        .put(DEPOSITAGREEMENT_SHORT, MediaType.parseMediaType(DEPOSITAGREEMENT_JSON_VALUE))

...
public class ExtractTopicFromDocument implements TopicIndexer {
    ...
    public ExtractTopicFromDocument() {
        ...
        topicHierarchy.put("http://onto.nerc.ac.uk/CEHMD/topic/3",  ImmutableList.of("0/Citizen science/"));
        topicHierarchy.put("http://onto.nerc.ac.uk/CEHMD/topic/4",  ImmutableList.of("0/Climate and climate change/"));
        topicHierarchy.put("http://onto.nerc.ac.uk/CEHMD/topic/5",  ImmutableList.of("0/Drought/"));
        ...
        topicHierarchy.put("http://onto.nerc.ac.uk/CEHMD/topic/8",  ImmutableList.of("0/Flooding/"));

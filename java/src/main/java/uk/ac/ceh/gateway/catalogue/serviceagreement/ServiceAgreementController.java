...
public class ServiceAgreementController {
    ...
    public RedirectView submitServiceAgreement(
        @ActiveUser CatalogueUser user,
        @PathVariable String id
    ) {
    ...
    public RedirectView publishServiceAgreement(
        @ActiveUser CatalogueUser user,
        @PathVariable String id
    ) {
        if (serviceAgreementService.metadataRecordExists(id)) {
    ...
    public RedirectView giveDepositorEditPermission(
        @ActiveUser CatalogueUser user,
        @PathVariable String id
    ) {
        if (serviceAgreementService.metadataRecordExists(id)) {
    ...
    public RedirectView formTransitionPublication(
        ...
        serviceAgreementService.transitState(user, id, toState);
        return new RedirectView("/service-agreement/" + id);
    }

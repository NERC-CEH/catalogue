<#assign custodianEIDC = func.filter(func.filter(otherContacts, "role", "custodian"), "organisationName", "NERC Environmental Information Data Centre") >
      ...
      <#if permission.userCanEditRestrictedFields(metadata.catalogue)>
        <div class="btn-group btn-group-sm" role="group">
          ...
          <#if metadata.documentType != 'LINK_DOCUMENT'>
            ...
            <#-- 'More' button -->
            <#if orders?has_content || custodianEIDC?size gte 1>
            <div class="btn-group btn-group-sm" role="group">

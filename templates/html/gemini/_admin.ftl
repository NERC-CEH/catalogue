...
<#if onlineResources?has_content>
  <#assign orders = 
  func.filterRegex(func.filter(onlineResources, "function", "order"), "url", "http://catalogue.ceh.ac.uk/download")
+func.filterRegex(func.filter(onlineResources, "function", "order"), "url", "https://order-eidc.ceh.ac.uk/resources/")>
</#if>

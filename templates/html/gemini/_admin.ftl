<#assign
  ...
  isEidcCustodian = func.filter(custodians, "organisationName", "Environmental Information Data Centre")?size gt 0
...
<#if onlineResources?has_content>
  <#assign
    ...
    orders = func.filterRegex(orderResources, "url", "https://order-eidc.ceh.ac.uk/resources/")
      ...
      <div class="btn-group btn-group-sm">
        ...
        <#if isRestrictedFieldsEditor>
          ...
          <ul class="dropdown-menu dropdown-menu-right">
            <li>
              <a href="/documents/${id?html}/permission">
                <i class="fas fa-users"></i>
                Permissions
              </a>
            </li>
            <li>
              <a href="/documents/${id?html}/publication">
            ...
            <li>
              <a href="/documents/${id?html}/catalogue"
            ...
            <div class="btn-group btn-group-sm" role="group">
              ...
              <ul class="dropdown-menu dropdown-menu-right">
                ...
                <#elseif !datacitable>
                  ...
                  <li>
                    <a href="https://www.eidc.ac.uk/admin/guidance/mintADOI"
                        target="_blank" 
                ...
                <#elseif datacitable>
                  <li>
                    <a href="/documents/${id?html}/datacite.xml">
                      View DataCite XML
                    </a>
                  </li>
                </#if>
            ...
            <div class="btn-group btn-group-sm" role="group">
              ...
              <ul class="dropdown-menu dropdown-menu-right">
                ...
                <#list orders>
                  <#items as testLink>
                    <#if testLink.function == "order">
                      <li>
                        <a href="${testLink.url?html}&test=true">Test order</a>
                      </li>
                    </#if>
                  </#items>
                </#list>
                <#if isEidcCatalogue && (isDraft || isEidcCustodian)>
                  <li>
                    <a href="https://jira.ceh.ac.uk/issues/?jql=cf%5B13250%5D%3D%22${id?html}%22"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                  ...
                  <li>
                    <a href="https://eidc.ceh.ac.uk/metadata/${id?html}/"
                        target="_blank" 
                        rel="noopener noreferrer"
                    >
                      DRH admin folder

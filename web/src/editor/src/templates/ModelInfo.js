...
<div class="row">
  <div class="col-sm-3 col-lg-3">
    <label for="modelInfo<%= data.index %>Version">Version</label>
  </div>
  <div class="col-sm-9">
    <input data-name="version" id="modelInfo<%= data.index %>Version" class="editor-input" value="<%= data.version %>">
  </div>
</div>
<div class="row">
  <div class="col-sm-3 col-lg-3">
    <label for="modelInfo<%= data.index %>Rationale">Rationale</label>
  </div>
  <div class="col-sm-9">

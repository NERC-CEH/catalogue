...
<div class="row">
    <div class="col-sm-1 col-lg-1">
        <label for="descriptiveKeyword<%= data.index %>Keyword<%= data.keywordIndex %>Value">Value</label>
    </div>
    ...
    <div class="col-sm-1 col-lg-1">
        <label for="descriptiveKeyword<%= data.index %>Keyword<%= data.keywordIndex %>Uri">Uri</label>
    </div>
    <div class="col-sm-11 col-lg-5">

...
<div class="row">
    ...
    <div class="col-sm-2">
        <label for="onlineResource<%= data.index %>Size">Approx. size (bytes)</label>
    </div>
    <div class="col-sm-4">
        <input data-name="size" type="number" id="onlineResource<%= data.index %>Size" class="editor-input" value="<%= data.size %>" <%= data.disabled%>>
    </div>
</div>
`)

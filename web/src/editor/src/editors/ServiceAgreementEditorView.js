    ...
    },
    {
      ...
      views: [
        ...
        new TextOnlyView({
          ...
          text: `
<p>Please state under which licence the data will be made available. The vast majority of NERC-funded data are provided under the <a href='https://eidc.ac.uk/licences/ogl/plain' target='_blank' rel='noopener noreferrer'>Open Government Licence</a>. We recommend that you seek guidance from your institution and/or funding agency as to the appropriate licence.</p>
`,
          required: true
        }),
...
<p>If an embargo is required, please specify the date the data are to be <b>made available</b> below.</p>
`
        }),

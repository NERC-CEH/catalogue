<div class="row">
  ...
  <div class="col-sm-10">
    <textarea data-name="citation" rows="4" id="reference<%= data.index %>Citation" class="editor-textarea"><%= data.citation %></textarea>
  </div>
</div>
<div class="row">
  <div class="col-sm-2">
...
<div class="row">
  <div class="col-sm-2">
    <label for="reference<%= data.index %>Nora">Link to NORA</label>
  </div>
  <div class="col-sm-10">

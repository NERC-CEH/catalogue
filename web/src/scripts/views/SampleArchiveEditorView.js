...
], function(EditorView, InputView, TextareaView, KeywordView, ParentView, ParentStringView, ParentStringTextboxView, PredefinedParentView, BoundingBox, Contact, MultipleDate, PointOfContact, TopicCategory, SaTaxa, SaPhysicalState, SaSpecimenType, SaTissue, BoundingBoxView, TemporalExtentView, SingleObjectView, SingleView, TopicCategoryView, SaTaxaView, SaPhysicalStateView, SaSpecimenTypeView, SaTissueView, PointOfContactView, OnlineLinkView, FundingView) { return EditorView.extend({

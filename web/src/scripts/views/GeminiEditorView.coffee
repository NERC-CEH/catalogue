define [
  ...
  'cs!views/editor/SupplementalGeminiView'
    ...
    ,
      ...
      views: [
        new ParentView
          ...
          ObjectInputView: SupplementalGeminiView
          helpText: """

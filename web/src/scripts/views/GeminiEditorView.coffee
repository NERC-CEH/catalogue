      ...
      views: [
        ...
        new InputView
          ...
          helpText: """
                    ...
                    <p>Please refer to <a href="https://www.eidc.ac.uk/help/createedit/metadataauthorguide" target="_blank" rel="noopener">guidance for metadata authors</a></p>
                    """
        ...
        new TextareaView
          ...
          helpText: """
                    ...
                    <p>Write in plain English; in other words, write complete sentences rather than fragments.  It is recommended that the abstract is organised using the "What, Where, When, How, Why, Who" structure - see <a href="https://www.eidc.ac.uk/help/createedit/metadataauthorguide" target="_blank" rel="noopener">guidance for metadata authors</a></p>
                    """
      ...
      views: [
        new TextareaView
          ...
          helpText: """
                    ...
                    <p>See <a href="https://www.eidc.ac.uk/help/createedit/metadataauthorguide" target="_blank" rel="noopener">guidance for metadata authors</a>.</p>
                    """

...
], function(EditorView, InputView, TextareaView, KeywordView, CheckboxView, ParentView, ParentStringView, ParentStringTextboxView, PredefinedParentView, BoundingBox, Contact, MultipleDate, BoundingBoxView, SingleObjectView, SingleView, ContactView, OnlineLinkView, ErammpModelInputView, ErammpModelOutputView, ReadOnlyView) { return EditorView.extend({

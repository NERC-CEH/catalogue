      ...
      <div class="card fw-bold mt-5">
        <div class="card-body">
          ...
          <ul>
            ...
            <li>the funder(s) permit its publication</li>
            <li>any third-party data used in its generation or derivation were accessed under terms and conditions which permit its subsequent publication</li>

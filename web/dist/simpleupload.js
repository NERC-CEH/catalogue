...
;// CONCATENATED MODULE: ./simple-upload/src/File/File.js

/* harmony default export */ const File = (backbone_default().Model.extend({
  defaults: {
    toDelete: false
  },
  idAttribute: 'name'
}));
;// CONCATENATED MODULE: ./simple-upload/src/File/File.tpl
// Module
var code = "<label><%= name %> <input type=\"checkbox\" <% if (toDelete) { %> checked=\"checked\" <% } %>/> </label>";
// Exports
/* harmony default export */ const File_File = (code);
...
;// CONCATENATED MODULE: ./simple-upload/src/File/FileView.js



/* harmony default export */ const FileView = (backbone_default().View.extend({
  tagName: 'li',
  events: {
    'change input': 'select'
  },
  initialize: function initialize() {
    this.template = index_default.template(File_File);
    this.listenTo(this.model, 'sync', this.remove);
    this.listenTo(this.model, 'change', this.render);
  },
  select: function select() {
    var previous = this.model.get('toDelete');
...
;// CONCATENATED MODULE: ./simple-upload/src/File/FileCollection.js


/* harmony default export */ const FileCollection = (backbone_default().Collection.extend({
  model: File,
  comparator: 'name',
...
;// CONCATENATED MODULE: ./simple-upload/src/File/Files.tpl
// Module
var Files_code = "<button class=\"select-all\">Select All</button> <button class=\"delete-selected\">Delete Selected</button>";
// Exports
/* harmony default export */ const Files = (Files_code);
;// CONCATENATED MODULE: ./simple-upload/src/File/FileListView.js




/* harmony default export */ const FileListView = (backbone_default().View.extend({
  events: {
  ...
  deleteSelected: function deleteSelected() {
    ...
    var toDelete = this.files.where({
      toDelete: true
    });

    if (confirm("Delete ".concat(toDelete.length, " files?"))) {
      var options = {
        success: function success(model) {
          _this.messages.add(new (backbone_default()).Model({
            message: "Deleted: ".concat(model.get('name')),
            type: 'info'
          }));
        },
        error: function error(model, response) {
          _this.messages.add(new (backbone_default()).Model(response));
        }
      };

      index_default.invoke(toDelete, 'destroy', options);
    }
  },
  ...
  render: function render() {
    this.$tools.html(index_default.template(Files));
    return this;
  }
}));
;// CONCATENATED MODULE: ./node_modules/just-extend/index.esm.js
var objectExtend = index_esm_extend;
...
function index_esm_extend(/* [deep], obj1, obj2, [objn] */) {
  var args = [].slice.call(arguments);
  var deep = false;
...
;// CONCATENATED MODULE: ./simple-upload/src/File/UploadView.js



/* harmony default export */ const UploadView = (backbone_default().View.extend({
  initialize: function initialize(options) {
    // Prevent Dropzone auto discovery
    $3ed269f2f0fb224b$export$2e2bcd8739ae039.simpleUploadDropzone = false; // Enable Dropzone CSS styling

    this.$el.addClass('dropzone');
    var dropzone = new $3ed269f2f0fb224b$export$2e2bcd8739ae039(this.el);
    dropzone.on('success', function (file) {
      options.messages.add(new (backbone_default()).Model({
        message: "Uploaded: ".concat(file.name),
        type: 'info'
      }));
      options.files.add(new File({
        name: file.name
      }));
    });
    dropzone.on('error', function (file, errorMessage) {
      return options.messages.add(new (backbone_default()).Model(errorMessage));
    });
...
;// CONCATENATED MODULE: ./simple-upload/src/File/index.js





;// CONCATENATED MODULE: ./simple-upload/src/Message/Message.tpl
// Module
var Message_code = "<span class=\"<%= type %>\"><%= message %></span>";
// Exports
/* harmony default export */ const Message = (Message_code);
;// CONCATENATED MODULE: ./simple-upload/src/Message/MessageView.js
...
;// CONCATENATED MODULE: ./simple-upload/src/Message/Messages.tpl
// Module
var Messages_code = "<button class=\"clear-all\">Clear</button>";
// Exports
/* harmony default export */ const Messages = (Messages_code);
;// CONCATENATED MODULE: ./simple-upload/src/Message/MessageListView.js




/* harmony default export */ const MessageListView = (backbone_default().View.extend({
  events: {
    'click .clear-all': 'clearAll'
  },
  initialize: function initialize(options) {
    this.template = index_default.template(Messages);
    this.messages = options.messages;
  ...
  clearAll: function clearAll() {
    index_default.invoke(this.messages.toArray(), 'destroy');
  },
  render: function render() {
    this.$tools.html(index_default.template(Messages));
    return this;
  }
}));
;// CONCATENATED MODULE: ./simple-upload/src/Message/index.js


;// CONCATENATED MODULE: ./simple-upload/src/App/SimpleUploadView.js




/* harmony default export */ const SimpleUploadView = (backbone_default().View.extend({
  initialize: function initialize(options) {
    var files = new FileCollection({
      url: options.url
    });
    var messages = new (backbone_default()).Collection();
    ...
    if (jquery_default()('#files-data').length) {
      files.reset(JSON.parse(jquery_default()('#files-data').text()));
    }

    if (jquery_default()('#messages-data').length) {
      return messages.reset(JSON.parse(jquery_default()('#messages-data').text()));
    }
  }
}));
;// CONCATENATED MODULE: ./simple-upload/src/App/index.js

;// CONCATENATED MODULE: ./simple-upload/src/index.js


jquery_default()(document).ready(function () {
  var url = jquery_default()('#simple-upload-dropzone').attr('action');
  var view = new SimpleUploadView({
    el: '#simple-upload',
    url: url
  });
});

...
__webpack_require__.d(modules_namespaceObject, {
  ...
  "head": () => (first),
  "identity": () => (identity),
  "include": () => (contains_contains),
  "includes": () => (contains_contains),
  "indexBy": () => (indexBy),
  "indexOf": () => (indexOf),
  "initial": () => (initial),
  "inject": () => (reduce),
...
// EXTERNAL MODULE: ./node_modules/jquery-ui/ui/widgets/tooltip.js
var tooltip = __webpack_require__(8181);
...
function isElement_isElement(obj) {
...
function debounce_debounce(func, wait, immediate) {
...
function contains_contains(obj, item, fromIndex, guard) {
...
/* harmony default export */ const omit = (restArguments(function(obj, keys) {
  ...
  if (modules_isFunction(iteratee)) {
    ...
    iteratee = function(value, key) {
      return !contains_contains(keys, key);
    };
  }
...
/* harmony default export */ const difference = (restArguments(function(array, rest) {
  ...
  return filter(array, function(value){
    return !contains_contains(rest, value);
  });
}));
...
function uniq(array, isSorted, iteratee, context) {
  ...
  for (var i = 0, length = _getLength(array); i < length; i++) {
    ...
    if (isSorted && !iteratee) {
      ...
      if (!contains_contains(seen, computed)) {
        seen.push(computed);
        result.push(value);
      }
    } else if (!contains_contains(result, value)) {
      result.push(value);
    }
  }
  return result;
...
function intersection(array) {
  ...
  for (var i = 0, length = _getLength(array); i < length; i++) {
    var item = array[i];
    if (contains_contains(result, item)) continue;
    var j;
    for (j = 1; j < argsLength; j++) {
      if (!contains_contains(arguments[j], item)) break;
    }
...
;// CONCATENATED MODULE: ./clipboard/src/ClipboardCopy/ClipboardCopy.tpl
// Module
var code = "<button type=\"button\" class=\"editor-button-xs\"> <i class=\"fas fa-clipboard\"></i> </button>";
// Exports
/* harmony default export */ const ClipboardCopy = (code);
;// CONCATENATED MODULE: ./clipboard/src/ClipboardCopy/ClipboardCopyView.js
...
/* harmony default export */ const ClipboardCopyView = (backbone_default().View.extend({
  events: {
  ...
  render: function render() {
    this.$el.html(index_default.template(ClipboardCopy));
    this.$('button').tooltip({
      title: 'copied',
      trigger: 'click'
    });
  ...
  copyToClipboard: function copyToClipboard(event) {
    copy(jquery_default()(event.currentTarget).data('selector'));
    self.clearTimeout(this.timeout);
    this.timeout = self.setTimeout(function () {
      return this.$('button').tooltip('hide');
    }, 1000);
  }
}));

var copy = function copy(selector) {
  var selection = self.getSelection();
  var range = document.createRange();
  var copyContent = document.querySelector(selector);
...
;// CONCATENATED MODULE: ./clipboard/src/ClipboardCopy/index.js

;// CONCATENATED MODULE: ./clipboard/src/index.js



jquery_default()(document).ready(function () {
  var view = new ClipboardCopyView({
    el: '.clipboard-copy'
  });
});
})();
